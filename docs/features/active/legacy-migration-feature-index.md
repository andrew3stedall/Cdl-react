...
Required active development planning features:

- `docs/features/active/authentication-and-session-management.md`
- `docs/features/active/application-shell-navigation-and-presets.md`
- `docs/features/active/squad-management-scouting-and-transfers.md`
- `docs/features/active/team-selection-and-chip-management.md`
- `docs/features/active/league-fixtures-and-table.md`
- `docs/features/active/rules-knowledge-base.md`
- `docs/features/active/analytics-dashboard.md`
- `docs/features/active/fixture-difficulty-ratings.md`
- `docs/features/active/backend-api-data-platform.md`
