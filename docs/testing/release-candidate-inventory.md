...
2. Isolate captaincy-specific mutation and validation coverage only if it remains release-critical after product review.
3. Decide whether Preferences should enter primary navigation; add browser evidence only after that product decision.
