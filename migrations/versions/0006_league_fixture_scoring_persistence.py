...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("home_team_id", ID, nullable=False),
        sa.Column("away_team_id", ID, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", ID, primary_key=True),
        sa.Column("fixture_id", ID, nullable=False),
        sa.Column("draft_team_id", ID, nullable=False),
        sa.Column("gameweek", sa.Integer(), nullable=False),
        sa.Column("points", sa.Integer(), nullable=False),
        sa.Column("bonus_points", sa.Integer(), nullable=False, server_default="0"),
        sa.Column("chips_played_json", sa.JSON(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("winner_team_id", ID, nullable=True),
    )
    op.create_table(
