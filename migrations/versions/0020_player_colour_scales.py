...
def upgrade() -> None:
    op.add_column(
        "user_preferences",
        sa.Column(
            "position_colour_scale", sa.String(length=32), nullable=False, server_default="Classic"
        ),
    )
    op.add_column(
        "user_preferences",
        sa.Column(
            "metric_colour_scale", sa.String(length=32), nullable=False, server_default="Blue"
        ),
    )
    op.add_column(
        "user_preferences",
        sa.Column(
            "metric_colour_scale_reversed", sa.Boolean(), nullable=False, server_default=sa.false()
        ),
    )
