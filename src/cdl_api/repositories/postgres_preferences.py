...
user_preferences_table = Table(
    ...
    Column("result_win_colour", String(7), nullable=False),
    Column("result_draw_colour", String(7), nullable=False),
    Column("result_loss_colour", String(7), nullable=False),
    Column("light_theme_colour", String(7), nullable=False),
    Column("dark_theme_colour", String(7), nullable=False),
    Column("primary_theme_colour", String(7), nullable=False),
...
class PostgreSQLUserPreferenceRepository:
    ...
    def get_for_user(self, user_id: str) -> UserPreferences:
        with self._session_factory() as session:
            preference_row = session.execute(
                select(
                    ...
                    user_preferences_table.c.result_win_colour,
                    user_preferences_table.c.result_draw_colour,
                    user_preferences_table.c.result_loss_colour,
                    user_preferences_table.c.light_theme_colour,
                    user_preferences_table.c.dark_theme_colour,
                    user_preferences_table.c.primary_theme_colour,
        ...
        return UserPreferences(
            ...
            result_win_colour=preference_row.result_win_colour,
            result_draw_colour=preference_row.result_draw_colour,
            result_loss_colour=preference_row.result_loss_colour,
            light_theme_colour=preference_row.light_theme_colour,
            dark_theme_colour=preference_row.dark_theme_colour,
            primary_theme_colour=preference_row.primary_theme_colour,
    ...
    def save_for_user(self, user_id: str, preferences: UserPreferences) -> UserPreferences:
        statement = postgres_insert(user_preferences_table).values(
            ...
            result_win_colour=preferences.result_win_colour,
            result_draw_colour=preferences.result_draw_colour,
            result_loss_colour=preferences.result_loss_colour,
            light_theme_colour=preferences.light_theme_colour,
            dark_theme_colour=preferences.dark_theme_colour,
            primary_theme_colour=preferences.primary_theme_colour,
