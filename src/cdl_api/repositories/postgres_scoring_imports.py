"""Transactional historical scoring-snapshot import projection."""
        ...
        *,
        ...
        with self._session_factory() as session:
            ...
            for record in batch.records:
                ...
                current_snapshot = self._payload(
                    session,
                    fixture_scoring_snapshots_table,
                    snapshot_id,
                )
                if current_snapshot == snapshot_payload:
                    ...
                    projected += 1
                    domain_changes.append((snapshot_id, snapshot_payload))
            ...
            for snapshot_id, payload in domain_changes:
                session.execute(
