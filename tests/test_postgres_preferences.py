...
def test_authenticated_preferences_persist_and_remain_isolated() -> None:
    ...
    assert client.put(
        ...
        json={
            ...
            "position_colour_mode": "name-font",
            ...
            "result_win_colour": "#16A34A",
            "result_draw_colour": "#D97706",
        ...
        "theme_colour_variants": {
            "light": {"primary": "#2563EB", "secondary": "#115E59", "tertiary": "#0D9488", "quaternary": "#C2410C"},
            "dark": {"primary": "#60A5FA", "secondary": "#115E59", "tertiary": "#0D9488", "quaternary": "#C2410C"},
        },
        "fdr_custom_min": "#1B9E77",
        "fdr_custom_second": "#8CCBB5",
        "fdr_custom_mid": "#F7F7F7",
    ...
    assert client.put(
        ...
        json={
            ...
            "metric_custom_4": "#F59E0B",
            "metric_custom_5": "#DC2626",
            "result_win_colour": "#14B8A6",
            "result_draw_colour": "#EAB308",
            "result_loss_colour": "#E11D48",
            "light_theme_colour": "#0F766E",
        ...
        "quaternary_theme_colour": "#14B8A6",
        "theme_colour_variants": {
            "light": {"primary": "#0F766E", "secondary": "#115E59", "tertiary": "#0D9488", "quaternary": "#14B8A6"},
            "dark": {"primary": "#2DD4BF", "secondary": "#115E59", "tertiary": "#0D9488", "quaternary": "#14B8A6"},
        },
        "fdr_custom_min": "#2166AC",
        "fdr_custom_second": "#8CAFD2",
        "fdr_custom_mid": "#F7F7F7",
    ...
    assert reloaded_repository.get_for_user("preferences-manager-2").result_win_colour == "#14B8A6"
    assert reloaded_repository.get_for_user("preferences-manager-2").result_draw_colour == "#EAB308"
    assert reloaded_repository.get_for_user("preferences-manager-2").result_loss_colour == "#E11D48"
